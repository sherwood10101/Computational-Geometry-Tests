...
RUN apt-get update && export DEBIAN_FRONTEND=noninteractive \
     && apt-get -y install --no-install-recommends cmake g++ libpng-dev libx11-dev libgl-dev libegl-dev libxrandr-dev libxinerama-dev libxcursor-dev libxi-dev libdrm-dev
